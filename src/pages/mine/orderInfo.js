        ...
        <ScrollView>
          <View style={styles.addressBox}>
            ...
            <View>
              <View style={{flexDirection: 'row', alignItems: 'flex-end'}}>
                <Text style={{color: '#3A3A3A', fontSize: 14}}>王大头</Text>
                <Text style={{fontSize: 12, color: '#989898', marginLeft: 2}}>
                  13187490192
                </Text>
              </View>
              <Text
          ...
          <View style={styles.orderList}>
            ...
            <View style={styles.list}>
              ...
              <View>
                <Text
                  style={{width: pxSize(215), color: '#3A3A3A', fontSize: 14}}>
                ...
                <View
                  ...
                  <Text style={{color: '#9D9D9D', fontSize: 14}}>X1</Text>
                </View>
              </View>
            </View>
            <View style={styles.list}>
          ...
          <View style={styles.bottomBox}>
            <Text style={{fontSize: 12, color: '#989898'}}>共5件</Text>
            <Text
              style={{
                fontSize: 12,
                color: '#3A3A3A',
            ...
            <Text style={{fontSize: 12, color: '#F12210', fontWeight: 'bold'}}>
              ￥1900.00
            </Text>
          </View>
        </ScrollView>
